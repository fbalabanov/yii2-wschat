<?php
namespace fbalabanov\wschat\components;

use Yii;
use fbalabanov\wschat\collections\History;

/**
 * Class ChatManager
 * @package \fbalabanov\wschat\components
 */
class ChatManager
{
    /** @var \fbalabanov\wschat\components\User[] */
    private $users = [];
     ...
     * @access public
     * @param $rid
     * @return \fbalabanov\wschat\components\ChatRoom|null
     */
     ...
     *
     * @access public
     * @param \fbalabanov\wschat\components\User $user
     * @param \fbalabanov\wschat\components\ChatRoom $chat
